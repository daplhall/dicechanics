...
def test_neg_num(StandardMathUnit):
	...
	assert unit.data.outcomes == [-5.5, -3, -1]


def test_pos_num(StandardMathUnit):
	unit = +StandardMathUnit
	assert unit.data.outcomes == [1, 3, 5.5]
