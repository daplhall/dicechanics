...
class Dice(object):
	...
	def _binary_level1(self, rhs: Dice_T, ops: BinaryFunc_T):
	...
	def __add__(self, rhs: object) -> Dice_T:
		"""
	...
	def __radd__(self, lhs: object) -> Dice_T:
		return self._binary_op(lhs, op.add)

	def __sub__(self, rhs: object) -> Dice_T:
		# needs to react to rounding
		return self._binary_op(rhs, op.sub)

	def __rsub__(self, lhs: object) -> Dice_T:
		return (-self)._binary_op(lhs, op.add)

	def __mul__(self, rhs: object) -> Dice_T:
		# Needs to react to rounding
		return self._binary_op(rhs, op.mul)

	def __rmul__(self, lhs: object) -> Dice_T:
		return self._binary_op(lhs, op.mul)

	def __truediv__(self, rhs: object) -> Dice_T:
		# needs to reach to rounding
		return self._binary_op(rhs, op.truediv)

	def __floordiv__(self, rhs: object) -> Dice_T:
		# needs to reach to rounding
		return self._binary_op(rhs, op.floordiv)

	def __lt__(self, rhs: object) -> Dice_T:
		return self._binary_op(rhs, op.lt)

	def __le__(self, rhs: object) -> Dice_T:
		return self._binary_op(rhs, op.le)

	def __ge__(self, rhs: object) -> Dice_T:
